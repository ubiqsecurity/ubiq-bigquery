/**
 * NOTE: This is the same auth.js as in the other broker function(s).
 * Please make sure that when updating this file, you update the other auth.js files accordingly.
 */
...
const auth = {
  ...
  headers(papi, sapi, endpoint, query, host, http_method) {
    ...
    const allHeaders = {};
    allHeaders['user-agent'] = `ubiq-bigquery/${Package.version}`;
